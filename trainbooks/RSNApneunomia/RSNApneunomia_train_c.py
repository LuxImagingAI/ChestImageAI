...
p.model_dict =  dict(
    ...
    num_classes = 1,
    #pretrained = 'imagenet', 
    pretrained = 'imagenet',#'/home/users/jsoelter/models/chexpert/fullmeta_503_consolidation_new/step00200.pt', #None, 'imagenet','imagenet', #
...
# +
p.computation = {
    'model_out': '/mnt/irisgpfs/users/bgarcia/jan_covid19/models',
    'device': "cuda:0"
}
